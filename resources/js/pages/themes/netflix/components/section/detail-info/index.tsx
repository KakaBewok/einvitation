    ...
    return (
        <div className="space-y-5 pb-10">
            ...
            <div className="space-y-4 px-4">
                ...
                {data.show_menu.gallery && <OurGallery gallery={data.gallery} show_menu={data.show_menu} />}
                <div className="pb-4 text-center">
                    ...
                    <a className="text-center underline" href="https://maps.app.goo.gl/CMA4urZ4bbFhvDoA8" target="_blank" rel="noopener noreferrer">
                        Lihat Lokasi
                    </a>
                </div>
